import "./App.css";
import { ScrollControls,Sparkles, Scroll, Environment,Float} from "@react-three/drei";
import "bootstrap/dist/css/bootstrap.min.css";
import Container from "react-bootstrap/Container";
import Row from "react-bootstrap/Row";
import Col from "react-bootstrap/Col";
import Button from "react-bootstrap/Button";
import { Butterfly } from "./models/Mbutterfly";
...
<EffectComposer>
      ...
      <ScrollControls pages={6} damping={0.25}>
        ...
        {/* top */}bhalse dita jaka  match kara kichi gote chadicha
        <Float
          speed={1} 
          rotationIntensity={2} 
          floatIntensity={0.2} 
